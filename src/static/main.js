...
function ReadRatio(){
    fetch('/static/Ratio.txt')
        ...
        .then(data => {
            ...
            //console.log(data);
            ratio = arr
            document.getElementById('textarea').textContent = ratio[0];
            document.getElementById('textarea2').textContent = ratio[1];
            document.getElementById('textarea3').textContent = ratio[2];
        })
}
