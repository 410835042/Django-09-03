...
class Account(AbstractBaseUser):
    ...
    gen = ((0, '女'), (1, '男'))
    gender = models.IntegerField(choices=gen, default=False, blank=True, null=False)
...
class Brand(models.Model):
    ...
    account = models.ForeignKey(Account, on_delete=models.CASCADE, default=None, related_name='brand')
...
class Cart(models.Model):
    ...
    product = models.ForeignKey('products.Product', on_delete=models.CASCADE, default=None, related_name='cart')
